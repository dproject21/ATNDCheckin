...
//@interface ATNDCheckInObject : NSObject
//@end

@interface ATNDCheckInObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ATNDCheckInObject class]])
		{
			for (NSString *key in [[(ATNDCheckInObject*)o modules] allKeys])
			{
