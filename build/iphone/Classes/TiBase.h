...
// in simulator we redefine to format for ATNDCheckIn Developer console
...
{\
	NSString * exceptionName = [@"org.atndcheckin." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.atndcheckin";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIATNDCheckInNativeItemNone = -1, 
	UIATNDCheckInNativeItemSpinner = -2,
	UIATNDCheckInNativeItemProgressBar = -3,
	
	UIATNDCheckInNativeItemSlider = -4,
	UIATNDCheckInNativeItemSwitch = -5,
	UIATNDCheckInNativeItemMultiButton = -6,
	UIATNDCheckInNativeItemSegmented = -7,
	
	UIATNDCheckInNativeItemTextView = -8,
	UIATNDCheckInNativeItemTextField = -9,
	UIATNDCheckInNativeItemSearchBar = -10,
	
	UIATNDCheckInNativeItemPicker = -11,
	UIATNDCheckInNativeItemDatePicker = -12,
	
	UIATNDCheckInNativeItemInfoLight = -13,
	UIATNDCheckInNativeItemInfoDark = -14,
	
	UIATNDCheckInNativeItemDisclosure = -15,
	
	UIATNDCheckInNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all ATNDCheckIn instances of
